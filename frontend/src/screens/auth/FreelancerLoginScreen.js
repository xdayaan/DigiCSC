...
const FreelancerLoginScreen = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      await login(email, password, 'freelancer', navigation);
    } catch (error) {
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.headerContainer}>
            <Text style={styles.header}>Freelancer Login</Text>
...
export default FreelancerLoginScreen;
