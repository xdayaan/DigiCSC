...
const CustomerSignupScreen = ({ navigation }) => {
  ...
  const { register, isLoading } = useAuth();  const handleSignup = async () => {
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.headerContainer}>
            ...
            <Text style={styles.subHeader}>Join DigiCSC as a customer</Text>
          </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={styles.textInputContainer}>
                ...
                >
                  ...
                  <Picker.Item label="Kumaoni" value="kumaoni" />
                  <Picker.Item label="Gharwali" value="gharwali" />
                </Picker>
              </View>
            </View>
